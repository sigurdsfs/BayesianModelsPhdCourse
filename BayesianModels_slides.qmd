...
- <img src="/images/schedule.png" width="1000px">
...
## Back to go-nogo
- **Observed**: behavior → number correct $k/n$
- **Latent**: ability → $\theta$
...
- Lower likelihood → weaker belief in $\theta$
...
## Optional stopping
- - ![](images/optional_stopping.png){width=100%}
...
- <span style="color:lightgray;">Assumes independent, identically distributed (i.i.d.) trials — no history effects</span>
...
## Simples!
- ![](images/simples.jpeg){width=2000%}
...
- See: `notebooks/probability distributions.ipynb`  
...
## Similarity: model vs. parameter inference
...
- Posterior distribution of models:  
  $$
  p(m \mid D) = \frac{p(D \mid m)\,p(m)}{p(D \mid M)}
  $$

- <span style="color:gray;">
Note: First denominator is conditional on a specific model \( m \), second sums across model space of models \( M \)
</span>
