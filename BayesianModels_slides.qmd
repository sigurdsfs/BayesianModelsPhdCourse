...
- Quantifies how much more likely the data is under $M_1$ than $M_2$
...
- $BF > 1$ → data favors $M_1$  
- $BF < 1$ → data favors $M_2$  
- $BF = 5$ → data is 5× more likely under $M_1$  
- $BF = \frac{1}{5}$ → data is 5× more likely under $M_2$  
- Strength of evidence depends on how far from 1 the ratio is

## Jeffreys' scale

- A rough guide for interpreting Bayes factors:  
