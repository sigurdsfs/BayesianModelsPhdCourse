...
## A cognitive example
- **Task** 10 trials of equal difficulty 
- - <span class="grey">e.g., go/no-go, task-switching, stop-go... etc.*</span>
- We want to estimate cognitive ability $\theta$
- $\theta$ = rate of correct performance
- $\theta$ is latent — we can’t observe it directly
- We can only observe behavior  → number of correct trials 

## Hidden Variables
- Hidden variables are **central** to cognitive modeling
- They let us **explain**, not just describe
- Descriptive: “8/10 correct”
- Explanatory: “What ability produced that?”
- Psych/neuro is always about **hidden causes**

## What’s observed vs. what’s hidden
- **Observed**: number correct
- **Hidden**: ability ($\theta$)
- Same $\theta$ → different outcomes
- Same performance ≠ same ability
- Our models infer causes from data

## Why we model hidden causes
- Our theories live in the **hidden layer**
- We care about *why*, not just *what*
- Real questions ask about causes, not outcomes
- e.g., *Do the two groups truly differ in ability?*
