...
- Efficient and ethically sound (esp. in randomised control trials)

## Why Frequentist Methods Don’t Allow This
- Frequentist inference assumes a fixed sample size
- Stopping early or collecting more data **invalidates p-values**
- Frequentist methods lack a way to incorporate prior knowledge

## Conjugate Priors
- If prior and posterior belong to the same family → **conjugate**
- Beta prior + Binomial likelihood = Beta posterior
- Enables analytic updates

## When Conjugacy Fails: Use MCMC
- MCMC = Markov Chain Monte Carlo
- Works even when no closed-form solution
- Approximates the posterior with sampling
...
- Blue pill: Trust the method and use it 😄

## Why Use Bayesian Methods?

- **Flexible**: Handles missing data, complex models
- **Principled**: Captures full uncertainty
- **Intuitive**: Matches how we reason
- **Scalable**: Easy to apply once you learn it
<!-- #endregion-->
