...
- **Criticism:** *BFs can prefer one bad model over another*  
...
- Priors matter: vague priors can be a liability  
...
- It **does** depend on parameter priors  
...
- Approximate methods include:  
  ...
  - Marginal likelihood identity:  
    $p(D \mid M) = \frac{p(D \mid \theta, M) \cdot p(\theta \mid M)}{p(\theta \mid D, M)}$  
- MCMC methods:  
  - Sample from posterior  
  - Use model indicators to switch between models
