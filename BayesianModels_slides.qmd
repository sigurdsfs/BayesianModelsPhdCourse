...
- `notebooks/probability_distributions.ipynb`> "Beliefs as distributions"

##  Probability mass functions
- For discrete variables which take finite number of values.
- <img src="/images/probability_mass.jpeg" width="500px">
- all probability mass sums to 1

## Probaility density functions
- Probability density function for continuous variables which take infinitely many values
- <img src="/images/probability_density.jpeg" width="500px">
- all probability density integrates to 1
- area under the curve is 1
- densities can exceed 1

## Interpreting probability distributions  
- Its important to be able to read and reason with probabilty distributions.
- `notebooks/probability_distributions.ipynb`> "Interpreting probability distributions"
...
- <br>
- Where $\theta$ is a parameter, here "ability", and D is data, here it is the correct performance, $k$ successes out of $n$ trials
- <br>
