...
## Overarching schematic
- ![](images/course_schema.jpg){width=100%}
- Your group project will reflect this workflow.
...
## Schedule
- Up to date schedule > See the GitHub > README.md
- LOCATION CHANGES BY DAY
...
## Overarching schematic
- ![](images/course_schema.jpg){width=100%}
- Your goup project will reflect this workflow.
...
- **Life is short.** Don't let things pass that you dont understand. 
...
## Course team
- Too shy to ask a question, talk to Janine
- Organisation, ask David or Ollie
- Technical issue / Github / Binder / Python > Simon
...
## Flipping the ratio
- If $BF_{12} < 1$, take the reciprocal: $BF_{21} = \frac{1}{BF_{12}}$  
...
- Fisherian methods test a single null hypothesis  
...
- Bayes factors are sensitive to prior choice  
- Especially important for point nulls (e.g. $\theta = 0$)  
- Priors must reflect genuine uncertainty or theory  
- Use sensitivity analysis: test how conclusions change with different priors  
- Critics argue: are sharp nulls ever really true?

## The arc of civilisation
Fire, the wheel, writing, zero, the printing press, Newtonian physics, germ theory, the steam engine, the combustion engine, the Moon landing, the internet, CRISPR, GPT-4, self-driving cars, **Bayes factors**
