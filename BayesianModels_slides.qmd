...
format:
  revealjs:
    title-slide: false  # ← This hides the auto-generated opening slide
    code-fold: true
    incremental: true
    toc: false # Enables a sidebar with slide titles
    toc-depth: 1
    slide-number: c/t
    execute:
    ...
    chalkboard:
      buttons: true
    preview-links: auto
    css: BayesianModels_styles.css
    footer:   |
      <a href="https://mybinder.org/v2/gh/ollie-hulme/BayesianModels/main?urlpath=lab/tree/BayesianModels" target="_blank">
        mybinder.org/v2/gh/ollie-hulme/BayesianModels
      </a>&nbsp;&nbsp;&nbsp;
      <a href="https://github.com/ollie-hulme/BayesianModels" target="_blank">
        github.com/ollie-hulme/BayesianModels
      </a>
...
## GitHub  
- All course materials + code on GitHub 👇  
- <img src="/images/github.png" alt="GitHub screenshot" width="450px">

## Schedule
- [Schedule link](https://docs.google.com/presentation/d/10HT1QZe-NeLPbn6CZ8mrn3OlBRqWR4Sq8N3HI9Vq0c4/edit#slide=id.p)
- Photograph the QR code to view schedule on your phone
- ![](images/google_slides_qr.png)
...
## Specific aims
- Focus on models of mind & behavior
- Connect to neural data via vanilla methods🧠
- Stop describing 🥱 → Start explaining 😌
- Hands-on · Interactive · Discursive
- Repetitive · A lil' redundant (on purpose!)
- KISS: Keep It Simple, Stoopid 😜
- Intuitive · Playful · Fun · Useful ✨

## Our expectations of youż:
...
## A cognitive example
- A subject performs a simple task (e.g. go/no-go)  
- 10 trials, equal difficulty  
- We want to estimate cognitive ability, $\theta$  
- $\theta$ = rate of correct performance  
- $\theta$ is **latent** — its hidden, we can't observe it directly  
- We observe *only* the number of correct trials  
- We are uncertain about $\theta$  
- But we know $0 < \theta < 1$

## Hidden Variables
- Modeling hidden variables is *central* to cognitive modeling  
- It’s how we **explain**, not just describe  
- Descriptive: “performance = 8/10”  
- Explanatory: “what underlying ability led to that?”  
- Psychology/neuroscience is always about **hidden causes**

## Why Hidden ≠ Observed?
- Number correct = **observable** variable  
- Ability $\theta$ = **hidden** variable
- Same $\theta$ can produce different outcomes  
- Theory lives in the **hidden layer**
- Often our deeper questions and theories are about the hidden not the observed. 
-  e.g. *is there a difference in ability between the two groups?*

## Prior Belief over $\theta$
- If agnostic: use a **uniform prior**  
- Equal probability to all $\theta$ values in (0,1)  
- Maximum uncertainty
...
- play with the sliders to represent different prior beliefs
- *e.g. certain low, certain high, uncertain low, uncertain high*
 
## Update prior with evidence from data
- Data: D = 9/10 trials correct
...
- $p(\theta|k,n) \sim beta(1+k,1+(n-k))$
- where $k$ is correct and $n$ is total
- thus for every possible observation we know precisely how to update our posterior
