...
-  To use the tools of probability theory to scientifically understand brains minds and behavior
 

## Specific aims
 
- Emphasis on the models of mind & behavior
- Integrate vanilla methods for connecting to neural data 🧠
- Stop describing 🥱 → start explaining 😌
- Hands-on / interactive / discursive 
- Repetitive / lil' bit redundant 
