...
- Run interactive code via Binder 👇  
- No installation needed — just click and go 😌  

## GitHub  
- All course materials and code are on GitHub 👇  
...
<!-- #endregion Preamble-->
<!-- #region Lecture#1 How to think Bayesian      -->
# Lecture#1: How to think like a Bayesian
...
## A cognitive example
- a subject performs a cognitive task (e.g. go-nogo) which has 10 trials of equal difficulty.
- we want to estimate cognitive ability $\theta$ which is the rate of correct performance.
- $\theta$ is hidden or "latent", we cannot observe it directly
- we can only observe its effect on the observed number of trials that were correct
...
## Why the difference between hidden variables and observed data? 
- number of trials correct is an *observable* consequence of ability $\theta$ which is hidden
- they are not the same
- the same ability $\theta$ can give rise to different data depending on chance
